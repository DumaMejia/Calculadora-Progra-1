Public Class PacienteExamen
    ...
    Private Sub PacienteExamen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        posicion = 0
        controlesInicio(True)
        obtenerdatos()
    End Sub
    Sub obtenerdatos()
        datatable = conexion.obtenerdatos().Tables("PacExam")
        datatable.PrimaryKey = New DataColumn() {datatable.Columns("Idexapaciente")}
    ...
    Private Sub SeleccionarDato()
        idc = DataGridView1.CurrentRow.Cells("Idexapaciente").Value.ToString()
    End Sub
    ...
    Private Sub filtrar(ByVal valor As String)
        ...
        bs.Filter = "nombre like '%" & valor & "%' or tipo nombre '%" & valor & "%'"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Button1.Text = "Buscar" Then
            ...
            DataGridView1.DataSource = conexion.obtenerdatos().Tables("PacExam").DefaultView
    ...
    Private Sub nuevoBT_Click(sender As Object, e As EventArgs) Handles nuevoBT.Click
        If nuevoBT.Text = "Nuevo" Then 'Nuevo
            ...
            limpiarCampos()
        Else 'Guardar
            Dim msg = conexion.mantenimientoPacienteExamen(New String() {
    ...
    Private Sub eliminarBT_Click(sender As Object, e As EventArgs) Handles eliminarBT.Click
        If eliminarBT.Text = "Eliminar" Then
            If (MessageBox.Show("Esta seguro de borrar " + TextBox1.Text, "Diagnostico",
                ...
                conexion.mantenimientoPacienteExamen(New String() {Me.Tag}, "eliminar")
                limpiarCampos()
            End If
        Else
            controlesInicio(True)
