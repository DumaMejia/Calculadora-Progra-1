Public Class traslado
    ...
    Private Sub SeleccionarDato()
        idc = DataGridView1.CurrentRow.Cells("Idtraslado").Value.ToString()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Button1.Text = "Buscar" Then
            ...
            DataGridView1.DataSource = conexion.obtenerdatos().Tables("traslado").DefaultView
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim Reporte As New TrasladoReporte1
        Reporte._idTra = Me.Tag
        Reporte.ShowDialog()
        mostrardatos()
    End Sub
End Class