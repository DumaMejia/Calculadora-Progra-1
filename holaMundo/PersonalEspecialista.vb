Public Class PersonalEspecialista
    ...
    End Sub
    Sub obtenerdatos()
        datatable = conexion.obtenerdatos().Tables("perespec")
        datatable.PrimaryKey = New DataColumn() {datatable.Columns("IdPerEspec")}

        ComboBox2.DataSource = conexion.obtenerdatos().Tables("personal").DefaultView()
        ComboBox2.DisplayMember = "nombre"
        ComboBox2.ValueMember = "personal.IdPersonal"

        ComboBox1.DataSource = conexion.obtenerdatos().Tables("especialista").DefaultView()
        ComboBox1.DisplayMember = "especialidad"
        ComboBox1.ValueMember = "especialista.IdEspecialista"
    ...
    Private Sub SeleccionarDato()
        idc = DataGridView1.CurrentRow.Cells("Idperespec").Value.ToString()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Button1.Text = "Buscar" Then
            ...
            DataGridView1.DataSource = conexion.obtenerdatos().Tables("perespec").DefaultView
    ...
    Private Sub nuevoBT_Click(sender As Object, e As EventArgs) Handles nuevoBT.Click
        If nuevoBT.Text = "Nuevo" Then 'Nuevo
            ...
            limpiarCampos()
        Else 'Guardar
            Dim msg = conexion.mantenimientoPersonalEspecialista(New String() {
                Me.Tag, ComboBox2.SelectedValue, ComboBox1.SelectedValue, TextBox2.Text
              }, cambio)
            If msg = "error" Then
    ...
    Private Sub eliminarBT_Click(sender As Object, e As EventArgs) Handles eliminarBT.Click
        If eliminarBT.Text = "Eliminar" Then
            If (MessageBox.Show("Esta seguro de borrar " + "este", " registro",
                ...
                conexion.mantenimientoPersonalEspecialista(New String() {Me.Tag}, "eliminar")
                limpiarCampos()
            End If
        Else
            controlesInicio(True)
