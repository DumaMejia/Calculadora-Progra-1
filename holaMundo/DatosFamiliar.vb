Public Class DatosFamiliar
    ...
    Private Sub DatosFamiliar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        posicion = 0
        controlesInicio(True)
        obtenerdatos()
    End Sub
    Sub obtenerdatos()
        datatable = conexion.obtenerdatos().Tables("Dfamilia")
        datatable.PrimaryKey = New DataColumn() {datatable.Columns("Idfamiliar")}
        ...
        ComboBox2.DataSource = conexion.obtenerdatos().Tables("genero").DefaultView()
        ComboBox2.DisplayMember = "genero"
        ComboBox2.ValueMember = "genero.Idgenero"
