Public Class consulta
    ...
    End Sub
    Sub obtenerdatos()
        datatable = conexion.obtenerdatos().Tables("CitaConsulta")
        datatable.PrimaryKey = New DataColumn() {datatable.Columns("Idconsulta")}
    ...
    Private Sub SeleccionarDato()
        idc = DataGridView1.CurrentRow.Cells("Idconsulta").Value.ToString()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Button1.Text = "Buscar" Then
            ...
            DataGridView1.DataSource = conexion.obtenerdatos().Tables("CitaConsulta").DefaultView
    ...
    Private Sub nuevoBT_Click(sender As Object, e As EventArgs) Handles nuevoBT.Click
        If nuevoBT.Text = "Nuevo" Then 'Nuevo
            ...
            limpiarCampos()
        Else 'Guardar
            Dim msg = conexion.mantenimientoConsulta(New String() {
    ...
    Private Sub eliminarBT_Click(sender As Object, e As EventArgs) Handles eliminarBT.Click
        If eliminarBT.Text = "Eliminar" Then
            If (MessageBox.Show("Esta seguro de borrar " + TextBox1.Text, "Diagnostico",
                ...
                conexion.mantenimientoConsulta(New String() {Me.Tag}, "eliminar")
                limpiarCampos()
            End If
        Else
            controlesInicio(True)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim Reporte As New ReporteConsulta
        Reporte._idCon = Me.Tag
        Reporte.ShowDialog()
        mostrardatos()
    End Sub
End Class