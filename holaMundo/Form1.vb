Public Class Form1
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Select Case ComboBox1.SelectedIndex
            Case 0
                ...
                ComboBox2.Items.Add("Dolar Estado Unidense")
                ComboBox2.Items.Add("Peso Mexicano")
                ComboBox2.Items.Add("Euro")
                ComboBox2.Items.Add("Dolar Canadience")
                ComboBox2.Items.Add("Peso Chileno")
                ComboBox2.Items.Add("Colon Salvadoreño")
                ComboBox2.Items.Add("Lempira")
                ComboBox2.Items.Add("Libra Esterlina")
                ComboBox2.Items.Add("Peso Colombiano")
                ComboBox2.Items.Add("Peso Argentino")

                ComboBox3.Items.Clear()
                ComboBox3.Items.Add("Dolar Estado Unidense")
                ComboBox3.Items.Add("Peso Mexicano")
                ComboBox3.Items.Add("Euro")
                ComboBox3.Items.Add("Dolar Canadience")
                ComboBox3.Items.Add("Peso Chileno")
                ComboBox3.Items.Add("Colon Salvadoreño")
                ComboBox3.Items.Add("Lempira")
                ComboBox3.Items.Add("Libra Esterlina")
                ComboBox3.Items.Add("Peso Colombiano")
                ComboBox3.Items.Add("Peso Argentino")
            Case 1
                ComboBox2.Items.Clear()
                ComboBox2.Items.Add("Kilogramo")
                ComboBox2.Items.Add("Gramo")
                ComboBox2.Items.Add("Miligramo")
                ComboBox2.Items.Add("Microgramo")
                ComboBox2.Items.Add("Tonelada larga")
                ComboBox2.Items.Add("Tonelada corta")
                ComboBox2.Items.Add("Stone")
                ...
                ComboBox3.Items.Add("Miligramo")
                ComboBox3.Items.Add("Microgramo")
                ComboBox3.Items.Add("Tonelada larga")
                ComboBox3.Items.Add("Tonelada corta")
                ComboBox3.Items.Add("Stone")
                ComboBox3.Items.Add("Libra")
                ComboBox3.Items.Add("Onza")
                ComboBox3.Items.Add("Tonelada")

            Case 2

                ComboBox2.Items.Clear()
                ComboBox2.Items.Add("Metro cubico")
                ComboBox2.Items.Add("Litro Cubico")
                ComboBox2.Items.Add("Mililitro")
                ComboBox2.Items.Add("Galon imperial")
                ComboBox2.Items.Add("Cuarto Imperial")
                ComboBox2.Items.Add("Pinta imperial")
                ComboBox2.Items.Add("Taza Imperial")
                ComboBox2.Items.Add("Onza Liquida")
                ComboBox2.Items.Add("Pie Cubico")
                ComboBox2.Items.Add("Pulgada Cubica")

                ComboBox3.Items.Clear()
                ComboBox3.Items.Add("Metro cubico")
                ComboBox3.Items.Add("Litro Cubico")
                ComboBox3.Items.Add("Mililitro")
                ComboBox3.Items.Add("Galon imperial")
                ComboBox3.Items.Add("Cuarto Imperial")
                ComboBox3.Items.Add("Pinta imperial")
                ComboBox3.Items.Add("Taza Imperial")
                ComboBox3.Items.Add("Onza Liquida")
                ComboBox3.Items.Add("Pie Cubico")
                ComboBox3.Items.Add("Pulgada Cubica")

            Case 3
                ComboBox2.Items.Clear()
                ComboBox2.Items.Add("Kilometro")
                ComboBox2.Items.Add("Metro")
                ComboBox2.Items.Add("Centimetro")
                ComboBox2.Items.Add("Milimetro")
                ComboBox2.Items.Add("Micrometro")
                ComboBox2.Items.Add("Nanometro")
                ...
                ComboBox3.Items.Clear()
                ComboBox3.Items.Add("Kilometro")
                ComboBox3.Items.Add("Metro")
                ComboBox3.Items.Add("Centimetro")
                ComboBox3.Items.Add("Milimetro")
                ComboBox3.Items.Add("Micrometro")
                ComboBox3.Items.Add("Nanometro")
                ComboBox3.Items.Add("Milla")
                ComboBox3.Items.Add("Yarda")
                ComboBox3.Items.Add("Pie")
                ComboBox3.Items.Add("Pulgada")
            ...
            Case 4
                ...
                ComboBox2.Items.Add("Kilobyte")
                ComboBox2.Items.Add("Megabyte")
                ComboBox2.Items.Add("Gigabyte")
                ComboBox2.Items.Add("Terabyte")
                ComboBox2.Items.Add("Petabyte")
                ComboBox2.Items.Add("Exabyte")
                ComboBox2.Items.Add("Zettabyte")
                ComboBox2.Items.Add("Yottabyte")

                ComboBox3.Items.Clear()
                ComboBox3.Items.Add("Bit")
                ComboBox3.Items.Add("Byte")
                ComboBox3.Items.Add("Kilobyte")
                ComboBox3.Items.Add("Megabyte")
                ComboBox3.Items.Add("Gigabyte")
                ComboBox3.Items.Add("Terabyte")
                ComboBox3.Items.Add("Petabyte")
                ComboBox3.Items.Add("Exabyte")
                ComboBox3.Items.Add("Zettabyte")
                ComboBox3.Items.Add("Yottabyte")

            Case 5

                ComboBox2.Items.Clear()
                ComboBox2.Items.Add("Milisegundo")
                ComboBox2.Items.Add("Segundo")
                ComboBox2.Items.Add("Minuto")
                ComboBox2.Items.Add("Hora")
                ComboBox2.Items.Add("Dia")
                ComboBox2.Items.Add("Semana")
                ComboBox2.Items.Add("Mes")
                ComboBox2.Items.Add("Año")
                ComboBox2.Items.Add("Decada ")
                ComboBox2.Items.Add("Siglo")

                ComboBox3.Items.Clear()
                ComboBox3.Items.Add("Milisegundo")
                ComboBox3.Items.Add("Segundo")
                ComboBox3.Items.Add("Minuto")
                ComboBox3.Items.Add("Hora")
                ComboBox3.Items.Add("Dia")
                ComboBox3.Items.Add("Semana")
                ComboBox3.Items.Add("Mes")
                ComboBox3.Items.Add("Año")
                ComboBox3.Items.Add("Decada ")
                ComboBox3.Items.Add("Siglo")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim Valor = Caja.Text
        Dim Selec = ComboBox3.SelectedIndex
        Select Case ComboBox1.SelectedIndex
            Case 0
                Select Case ComboBox2.SelectedIndex
                    Case 0
                        Array = {1, 21.98, 0.85, 1.32, 793.1, 8.75, 24.66, 0.76, 3836, 73.59}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 1
                        Array = {3.35, 1, 0.039, 0.06, 36.09, 0.4, 1.12, 0.035, 174.76, 3.35}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 2
                        Array = {1.18, 25.92, 1, 1.55, 935.46, 10.29, 28.99, 0.9, 4489.79, 86.8}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 3
                        Array = {0.76, 16.68, 601.94, 1, 6.62, 18.66, 0.58, 2889.05, 0.64, 55.85}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 4
                        Array = {0.0013, 0.0277, 0.0011, 0.011, 1, 0.034, 0.001, 4.8, 0.0017, 0.0928}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 5
                        Array = {0.11, 2.52, 0.0922, 0.15, 90.91, 1, 2.82, 0.0876, 436.33, 8.44}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 6
                        Array = {0.0407, 0.89, 0.0345, 0.0536, 32.27, 0.35, 1, 0.0344, 154.87, 2.99}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 7
                        Array = {1.31, 28.76, 1.11, 1.72, 1038.13, 11.42, 32.17, 1, 4982.54, 96.32}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 8
                        Array = {0.0003, 0.0058, 0.0002, 0.0003, 0.21, 0.0023, 0.0065, 0.0002, 1, 0.0193}
                        Respuesta.Text = Valor * Array(Selec)
                    Case 9
                        Array = {0.136, 0.3, 0.0115, 0.0179, 10.78, 0.12, 0.33, 0.0104, 51.73, 1}
                        Respuesta.Text = Valor * Array(Selec)
                End Select
