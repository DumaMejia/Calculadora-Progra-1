Public Class DetalleReceta
    ...
    Private Sub DetalleReceta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    End Sub
    Sub obtenerdatos()
        datatable = conexion.obtenerdatos().Tables("Dreceta")
        datatable.PrimaryKey = New DataColumn() {datatable.Columns("IdDreceta")}
    ...
    Private Sub SeleccionarDato()
        idc = DataGridView1.CurrentRow.Cells("IdDreceta").Value.ToString()
    End Sub
    ...
    Private Sub nuevoBT_Click(sender As Object, e As EventArgs) Handles nuevoBT.Click
        If nuevoBT.Text = "Nuevo" Then 'Nuevo
            ...
            limpiarCampos()
        Else 'Guardar
            Dim msg = conexion.mantenimientoDreceta(New String() {
    ...
    Private Sub eliminarBT_Click(sender As Object, e As EventArgs) Handles eliminarBT.Click
        If eliminarBT.Text = "Eliminar" Then
            If (MessageBox.Show("Esta seguro de borrar " + "este", " registro",
                ...
                conexion.mantenimientoDreceta(New String() {Me.Tag}, "eliminar")
                limpiarCampos()
            End If
        Else
            controlesInicio(True)
