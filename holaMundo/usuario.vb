Public Class usuario
    ...
    End Sub
    Sub obtenerdatos()
        datatable = conexion.obtenerdatos().Tables("usuario")
    ...
    Private Sub filtrar(ByVal valor As String)
        ...
        bs.Filter = "username like '%" & valor & "%' or username like '%" & valor & "%'"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Button1.Text = "Buscar" Then
            ...
            DataGridView1.DataSource = conexion.obtenerdatos().Tables("usuario").DefaultView
