Public Class BuscarCompra
    ...
    Private Sub BuscarVenta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DataGridView1.DataSource = objconexion.obtenerdatos().Tables("CompraM").DefaultView
    End Sub
    ...
    Private Sub seleccionarDato()
        idc = DataGridView1.CurrentRow.Cells("IdCompra").Value.ToString()
        Close()
    End Sub
    Private Sub filtrar(ByVal valor As String)
        Dim bs As New BindingSource()
        bs.DataSource = DataGridView1.DataSource
        bs.Filter = "proveedor like '%" & valor & "%' or proveedor like '%" & valor & "%'"
